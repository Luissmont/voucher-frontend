  ...
  return (
    <main className="min-h-screen bg-[#152D4F] flex flex-col items-center justify-center px-6 py-10">
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="mb-6">
          <div className="w-24 h-24 bg-[#00b4d8] rounded-2xl flex items-center justify-center relative overflow-hidden">
            <span className="text-white text-5xl font-bold">V</span>
          </div>
        </div>

        <h1 className="text-white text-4xl font-bold mb-3">VouCher</h1>
